...
#
# Commands:
#   hubot morse encode <text> - encodes the given text to morse code
#   hubot morse decode <text> - decodes the given text from morse code
#
# Notes:
...
module.exports = (robot) ->
  ...
  robot.respond /morse encode (.*)/i, (msg) ->
    msg.send xmorse.encode(msg.match[1], option)

  robot.respond /morse decode (.*)/i, (msg) ->
